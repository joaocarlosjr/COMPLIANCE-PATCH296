...
-- Nova Rotina     - pkb_integr_conhec_transp_ff - Rotina para ler os campos flex-field menos os campos mult_org e hash.
--
...
-- Procedimento que faz validações no Conhecimento de Transporte e grava na CSF - campos flex field 
