...
-------------------------------------------------------------------------------------------------------
--
-- Em 26/01/2021    - Luis Marques - 2.9.6-2 / 2.9.7
-- Redmine #74016   - Criar DT_EXE_SERV no conhecimento de transporte
-- Nova Rotina      - pkb_ler_multorg_hash_ff - Rotina para leitura e validação do mult_org e hash vindos na tabela 
--                    "VW_CSF_CONHEC_TRANSP_FF".
-- Rotina Alteradas - pkb_conhec_transp_ff - Alterado para ler os campos da view "VW_CSF_CONHEC_TRANSP_FF" menos o mult_org e
--                    hash.
--                    pkb_ler_Conhec_Transp - Incluida nova rotina "pkb_ler_multorg_hash_ff" e colocado chamada da rotina
--                    "pkb_conhec_transp_ff" pos inclusão do donhecimento.
--
